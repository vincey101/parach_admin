...
function EditTutor() {
    ...
    const updateDetails = async (e) => {
        ...
        try {
            ...
            const editDoc = doc(db, "tutors", id);
        ...
        <div className="newContainer">
            ...
            <div className="newBottom">
                ...
                <div className="newBottom-right">
                    <form className='myform' onSubmit={updateDetails}>
                        ...
                        <div className="forminput">
                            ...
                            <input type="text" className='myinput' defaultValue={tutor.course} required placeholder='use comma to separate multiple courses' name='course' multiple onChange={changeField} />
                        </div>
                        <div className="forminput">
                            <label htmlFor="" className='mylabel'>Firstname</label>
                            <input type="text" name='firstname' className='myinput' required defaultValue={tutor.firstname} placeholder='John' onChange={changeField} />
                        </div>
                        <div className="forminput">
                            <label htmlFor="" className='mylabel'>Lastname</label>
                            <input type="text" name='lastname' className='myinput' defaultValue={tutor.lastname} placeholder='Doe' onChange={changeField} />
                        </div>
                        <div className="forminput">
                            <label htmlFor="" className='mylabel'>Address</label>
                            <input type="text" name='address' className='myinput' defaultValue={tutor.address} placeholder='25, john doe street Ibadan,Nigeria' onChange={changeField} />
                        </div>
                        <div className="forminput1">
                            <label htmlFor="" className='mylabel'>Phone number</label>
                            <input type="text" name='tel' className='myinput' required defaultValue={tutor.tel} placeholder='+234 8081388932' onChange={changeField} />
                        </div>
